...
public class RegisterActivity extends AppCompatActivity {
    ...
    public final String[] languageArr = {"polish", "polglish", "english"};
    public final String[] countryArr = {"Poland", "England", "Polgland"};
    public final String[] genderArr = {"male", "female", "programmer"};
    ...
    private void saveAccount(Account account){
        try {
            AccountsManager manager = new AccountsManager(this,account.getLogin());
    ...
    private Account getAccountFromFields() {
        ...
        if (areRequiredFieldsFilled() == true) {
            ...
            account.setLogin(loginEditText.getText().toString());
            account.setPassword(loginEditText.getText().toString());
